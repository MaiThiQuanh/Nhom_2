...
session_start();
	...
	$db = new Db();
	$manufactures = $db -> getAllmanufacture();
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tbody>
							<?php foreach ($manufactures as $key => $manufacture) {?>
							<tr class="">
								<td><?php echo $manufacture['manu_ID'] ?></td>
								<td><?php echo $manufacture['manu_name'] ?></td>
								<td><img src="public/images/manufactures/<?php echo $manufacture['manu_img'] ?>" style="width:100px"></td>
								<td>
